...
import { X, Users, Download, MessageCircle, UserPlus, CheckCircle, XCircle, Clock } from "lucide-react";
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-400 text-sm">
                            {participant._id === currentUserId ? "You" : 
                             participant._id === event.organizer._id ? "Organizer" : "Participant"}
                          </p>
                        </div>
                        {participant._id !== currentUserId && (
                          <button
                            onClick={() => onMessage(participant._id)}
                  ...
                  {pendingRequests.map((request) => (
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <img
                          src={request.user.avatar || `https://ui-avatars.com/api/?name=${request.user.username}`}
                        ...
                        <div className="flex gap-2">
                          <button
                            onClick={() => onApproveRequest && onApproveRequest(event._id, request._id)}
                          ...
                          <button
                            onClick={() => onRejectRequest && onRejectRequest(event._id, request._id)}
