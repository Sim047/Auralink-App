...
## Overview
Fully functional event booking, approval, and participant management system for the Auralink platform. Organizers can now manage join requests and view/export participant lists, while participants can see other attendees.
